...
import logging
import unittest
from app.http_handlers import get_google_address_handler

class TestGetGoogleAddressHandler(unittest.TestCase):
    '''unit tests for get_google_address_handler'''
    ...
    def test_get_google_address_handler_true(self):
