...
import logging
import unittest
from app.http_handlers import post_google_geo_handler

class TestPostGoogleGeoHandler(unittest.TestCase):
    '''unit tests for post_google_geo_handler'''
    ...
    def test_post_google_geo_handler_true(self):
