...
import logging
import unittest
from app.http_handlers import get_versions_handler

class TestGetVersionsHandler(unittest.TestCase):
    '''unit tests for get_versions_handler'''
    ...
    def test_get_versions_handler_true(self):
