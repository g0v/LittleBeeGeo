...
def _log_entry(data=''):
    cfg.logger.debug('log_entry_start: url: %s method: %s remote_route: %s request.cotent_type', request.url, request.method, request.remote_route, request.content_type)
