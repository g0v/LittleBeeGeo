...
import logging
import unittest
from app.http_handlers import g_ad_data_handler

class TestGAdDataHandler(unittest.TestCase):
    '''unit tests for g_ad_data_handler'''
    ...
    def test_g_ad_data_handler_true(self):
