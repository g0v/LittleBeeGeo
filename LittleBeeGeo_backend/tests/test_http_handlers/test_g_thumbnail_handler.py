...
import logging
import unittest
from app.http_handlers import g_thumbnail_handler

class TestGThumbnailHandler(unittest.TestCase):
    '''unit tests for g_thumbnail_handler'''
    ...
    def test_g_thumbnail_handler_true(self):
