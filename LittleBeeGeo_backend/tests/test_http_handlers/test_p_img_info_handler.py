...
import logging
import unittest
from app.http_handlers import p_img_info_handler

class TestPImgInfoHandler(unittest.TestCase):
    '''unit tests for p_img_info_handler'''
    ...
    def test_p_img_info_handler_true(self):
